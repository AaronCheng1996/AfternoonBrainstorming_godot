...
var divided: int = 10
enum TriggerEvent { VICTORY, DRAW, LUCKY_EVENT, FIRST_STRIKE, ADD_ATTACK, NONE }
...
func on_piece_set() -> void:
	...
	attack_component.ATK_PATTERN = Global.rng.randi_range(0, Global.PatternNames.size() - 2)
	#隨機事件
